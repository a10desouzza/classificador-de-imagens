...
que o coprocessador possui e, por padrão, 16 bits para dados e 13 para endereçamento de memória, as intruções possuem campos e formatos diferentes, sendo assim nem todas as instruções utilizam os 32 bits.
</details>
